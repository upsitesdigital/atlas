...
function customizer_repeater_refresh_general_control_values() {
  ...
  jQuery('.customizer-repeater-general-control-repeater').each(function() {
    ...
    th.find('.customizer-repeater-general-control-repeater-container').each(function() {
      ...
      var image_mobile_url = jQuery(this).find('.custom-media-mobile-url').val();
      var choice = jQuery(this).find('.customizer-repeater-image-choice').val();
      var title = jQuery(this).find('.customizer-repeater-title-control').val();
      var subtitle = jQuery(this).find('.customizer-repeater-subtitle-control').val();
      var field01 = jQuery(this).find('.customizer-repeater-field01-control').val();
      var field02 = jQuery(this).find('.customizer-repeater-field02-control').val();
      var field03 = jQuery(this).find('.customizer-repeater-field03-control').val();
      var field04 = jQuery(this).find('.customizer-repeater-field04-control').val();
      var field05 = jQuery(this).find('.customizer-repeater-field05-control').val();
      var field06 = jQuery(this).find('.customizer-repeater-field06-control').val();
      var field07 = jQuery(this).find('.customizer-repeater-field07-control').val();
      var field08 = jQuery(this).find('.customizer-repeater-field08-control').val();
      var field09 = jQuery(this).find('.customizer-repeater-field09-control').val();
      var field10 = jQuery(this).find('.customizer-repeater-field10-control').val();
      ...
      if (text !== '' || image_url !== '' || image_mobile_url !== '' || title !== '' || subtitle !== '' || field01 !== '' || field02 !== '' || field03 !== '' || field04 !== '' || field05 !== '' || field06 !== '' || field07 !== '' || field08 !== '' || field09 !== '' || field10 !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '') {
        values.push({
          ...
          'image_mobile_url': (choice === 'customizer_repeater_none' ? '' : image_mobile_url),
          'choice': choice,
          'title': escapeHtml(title),
          'subtitle': escapeHtml(subtitle),
          'field01': escapeHtml(field01),
          'field02': escapeHtml(field02),
          'field03': escapeHtml(field03),
          'field04': escapeHtml(field04),
          'field05': escapeHtml(field05),
          'field06': escapeHtml(field06),
          'field07': escapeHtml(field07),
          'field08': escapeHtml(field08),
          'field09': escapeHtml(field09),
          'field10': escapeHtml(field10),
...
jQuery(document).ready(function() {
  ...
  media_upload('.customizer-repeater-custom-media-mobile-button');
  jQuery('.custom-media-mobile-url').on('change', function() {
    customizer_repeater_refresh_general_control_values();
    return false;
  });
  ...
  theme_conrols.on('click', '.customizer-repeater-new-field', function() {
    ...
    var count = th.find('.customizer-repeater-general-control-repeater-container:last').find('.customizer-repeater-customize-control-title .count').html();
    console.log(count++);
    if (typeof th !== 'undefined') {
      ...
      if (typeof field !== 'undefined') {
        field.find('.customizer-repeater-customize-control-title .count').html(count++);
        ...
        field.find('.custom-media-mobile-url').val('');
        ...
        /*Remove value from field field*/
        field.find('.customizer-repeater-field01-control').val('');
        field.find('.customizer-repeater-field02-control').val('');
        field.find('.customizer-repeater-field03-control').val('');
        field.find('.customizer-repeater-field04-control').val('');
        field.find('.customizer-repeater-field05-control').val('');
        field.find('.customizer-repeater-field06-control').val('');
        field.find('.customizer-repeater-field07-control').val('');
        field.find('.customizer-repeater-field08-control').val('');
        field.find('.customizer-repeater-field09-control').val('');
        field.find('.customizer-repeater-field10-control').val('');
  ...
  theme_conrols.on('keyup', '.customizer-repeater-field01-control', function() {
    customizer_repeater_refresh_general_control_values();
  });
  theme_conrols.on('keyup', '.customizer-repeater-field02-control', function() {
    customizer_repeater_refresh_general_control_values();
  });
  theme_conrols.on('keyup', '.customizer-repeater-field03-control', function() {
    customizer_repeater_refresh_general_control_values();
  });
  theme_conrols.on('keyup', '.customizer-repeater-field04-control', function() {
    customizer_repeater_refresh_general_control_values();
  });
  theme_conrols.on('keyup', '.customizer-repeater-field05-control', function() {
    customizer_repeater_refresh_general_control_values();
  });
  theme_conrols.on('keyup', '.customizer-repeater-field06-control', function() {
    customizer_repeater_refresh_general_control_values();
  });
  theme_conrols.on('keyup', '.customizer-repeater-field07-control', function() {
    customizer_repeater_refresh_general_control_values();
  });
  theme_conrols.on('keyup', '.customizer-repeater-field08-control', function() {
    customizer_repeater_refresh_general_control_values();
  });
  theme_conrols.on('keyup', '.customizer-repeater-field09-control', function() {
    customizer_repeater_refresh_general_control_values();
  });
  theme_conrols.on('keyup', '.customizer-repeater-field10-control', function() {
    customizer_repeater_refresh_general_control_values();
  });
