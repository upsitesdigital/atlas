...
function customizer_repeater_refresh_general_control_values() {
  ...
  jQuery('.customizer-repeater-general-control-repeater').each(function() {
    ...
    th.find('.customizer-repeater-general-control-repeater-container').each(function() {
      ...
      if (text !== '' || image_url !== '' || image_mobile_url !== '' || title !== '' || field01 !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '') {
        values.push({
...
jQuery(document).ready(function() {
  ...
  theme_conrols.on('click', '.customizer-simple-repeater-customize-control-title', function() {
  ...
  theme_conrols.on('click', '.customizer-repeater-new-field', function() {
    ...
    var count = th.find('.customizer-repeater-general-control-repeater-container:last').find('.customizer-simple-repeater-customize-control-title .count').html();
    console.log(count++);
    if (typeof th !== 'undefined') {
      ...
      if (typeof field !== 'undefined') {
        field.find('.customizer-simple-repeater-customize-control-title .count').html(count++);
        ...
        /*Remove value from field01 field*/
